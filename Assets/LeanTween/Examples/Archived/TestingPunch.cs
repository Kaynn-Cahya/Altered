...
public class TestingPunch : MonoBehaviour {
    ...
    {        
        ...
        if (Input.GetKeyDown(KeyCode.C))
        {
            ...
            UnityEngine.Color to = new UnityEngine.Color(Random.Range(0f,1f),0f, Random.Range(0f,1f),0.0f);
        ...
        {
            LeanTween.value(gameObject, this.updateColor, new UnityEngine.Color(1.0f,0.0f,0.0f,1.0f), UnityEngine.Color.blue, 4.0f );//.setRepeat(2).setLoopPingPong().setEase(LeanTweenType.easeOutBounce);
        }
